...
# Режим создания датасета: "full" или "window_50"
# full: как сейчас + фича transactions_seen (сколько транзакций по клиенту уже в датасете)
# window_50: те же метрики, но считаются только по последним 50 транзакциям клиента
DATASET_MODE = "window_50"
WINDOW_TRANSACTIONS = 50
