#!/usr/bin/env python3
"""
Последовательно: training/xgb_grid_search.py, затем training/catboost_train.py.
При ненулевом коде первой команды вторая всё равно запускается.

Запуск из корня репозитория:
  python scripts/run_xgb_grid_then_catboost.py
"""
